<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="APLiberary.home" %>
...
<body>
 ...
 <asp:HyperLink id="HyperLink2" 
		...
		<div class="container-contact2">
			<div class="wrap-contact2">
				<form class="contact2-form validate-form" runat="server">
                        ...
                        <asp:TextBox placeholder="Search books" ID="search" runat="server" class="input2" type="text" name="email" TextMode="Search" required="required" Height="47px" Width="652px"></asp:TextBox>
					</div>
  ...
  <asp:Button ID="searchButton" runat="server" Text="Search" OnClick="searchButton_Click" BackColor="#FF3300" ForeColor="White" Height="52px" Width="274px" />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <asp:Button ID="showall" runat="server" Text="Show All" OnClick="showall_Click" BackColor="#FF3300" ForeColor="White" Height="52px" Width="273px" />

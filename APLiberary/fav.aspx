<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fav.aspx.cs" Inherits="APLiberary.fav" %>
  ...
  <!-- Page Content -->
		...
		<div class="container-contact2">
          ...
          <asp:BoundField DataField="title" HeaderText="Title" />
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                    <asp:LinkButton ID="lnkview" runat="server" CommandArgument='<%# Eval ("ID") %>' OnClick ="lnk_onclick">comments</asp:LinkButton>
                    <asp:LinkButton ID="lnkdelete" runat="server" CommandArgument='<%# Eval ("ID") %>' OnClick ="lnk_delete">remove</asp:LinkButton>
                        </ItemTemplate>
                </asp:TemplateField>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yourcomments.aspx.cs" Inherits="APLiberary.yourcomments" %>
 ...
 <asp:HyperLink id="HyperLink2" 
            ...
            <li class="nav-item">
               ...
               <asp:HyperLink id="HyperLink3" 
                  class="nav-link"
                  NavigateUrl="yourcomments.aspx"
                  Text="Manage your comments"
                  runat="server"/>
		...
		<div class="container-contact2">
			<div class="wrap-contact2">
				<form class="contact2-form validate-form" runat="server">
                      ...
                      <asp:Label ID="lblsc" runat="server" Text="" ForeColor="green"></asp:Label>
                    ...
                    <div class="">
                      <asp:GridView  ID="gridcontact" runat="server" AutoGenerateColumns="false" Width="99%" 
                CssClass="mygrdContent" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" RowStyle-CssClass="rows" 
            AllowPaging="True" Height="94px">
            <Columns>
           <asp:BoundField DataField="title" HeaderText="Title" />
                ...
                <asp:BoundField DataField="location" HeaderText="location" />
                                ...
                                <br />
                                <br />
                    <asp:Label ID="Label1" Text="Your Comments...." runat="server"/>
                                <br />
                                <br />
                            <div class="">
                      <asp:GridView  ID="GridView1" runat="server" AutoGenerateColumns="false" Width="99%" 
                CssClass="mygrdContent" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" RowStyle-CssClass="rows" 
            AllowPaging="True" Height="128px">
            <Columns>
                <asp:BoundField DataField="comment" HeaderText="comment" />
                <asp:BoundField DataField="name" HeaderText="Wrote by" />
                ...
                <asp:TemplateField>
                    ...
                    <asp:LinkButton ID="lnkdelete" runat="server" CommandArgument='<%# Eval ("ID") %>' OnClick ="lnk_delete">Delete</asp:LinkButton>
                      ...
                      <div class="wrap-input2 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
                        <asp:TextBox ID="comment" runat="server" class="input2" type="text" name="email" TextMode="MultiLine" required="required" placeholder="Write your comment here...."></asp:TextBox>
					</div>
					...
					<div class="container-contact2-form-btn">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <asp:Button ID="btnsave" runat="server" Text="Post" OnClick="btnsave_Click" BackColor="#FF3300" ForeColor="White" Height="52px" Width="169px" />

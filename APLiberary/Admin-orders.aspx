<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin-orders.aspx.cs" Inherits="APLiberary.Admin_orders" %>
...
<asp:HyperLink id="HyperLink3" 
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       ...
       <asp:BoundField DataField="title" HeaderText="Title" />
                <asp:BoundField DataField="adress" HeaderText="shipping adress " />
                <asp:BoundField DataField="quan" HeaderText="quantity" />
                <asp:BoundField DataField="statue" HeaderText="statue" />
                <asp:TemplateField>
                    <ItemTemplate>
                    <asp:LinkButton ID="lnkview" runat="server" CommandArgument='<%# Eval ("ID") %>' OnClick ="lnk_onclick">Shipped -</asp:LinkButton>
                    <asp:LinkButton ID="lnkdelete" runat="server" CommandArgument='<%# Eval ("ID") %>' OnClick ="lnk_delete">- Recieved -</asp:LinkButton>
                         <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval ("ID") %>' OnClick ="desc">- Delete order</asp:LinkButton>
